...
Create config file in catalog - /etc/rsyslog.d/ with content which is specified
================

This is the configuration file - /etc/rsyslog.d/rootsh.conf with the contents after creation.
